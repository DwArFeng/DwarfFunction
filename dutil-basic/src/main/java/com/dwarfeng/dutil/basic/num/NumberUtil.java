 ...
 * 数据转换类。
 * <p>
 * 提供常用的数据转换方法与常用的数据结构与byte数组相互转换的方法。
 * <p>
...
public final class NumberUtil {
	...
	/**
	 * 将byte数组进行裁剪到达指定的位数。 如果数组的位数多余指定的位数，则进行裁剪；如果数组的位数少于指定的位数，则进行补0。
	 * 
	 * @param bytes
	 *            指定的数组。
	 * @param length
