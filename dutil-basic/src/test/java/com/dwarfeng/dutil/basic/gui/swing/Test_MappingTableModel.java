...
public class Test_MappingTableModel {
	...
	private static final Employee EMPLOYEE_NEWBEE = new Employee(4, "Newbee", 300.0);
	...
	public final void testRemoveAll() {
		assertTrue(tableModel.removeAll(Arrays.asList(EMPLOYEE_DWARFENG, EMPLOYEE_RAE, EMPLOYEE_NEWBEE)));
	...
	public final void testRetainAll() {
		assertTrue(tableModel.retainAll(Arrays.asList(EMPLOYEE_DWARFENG, EMPLOYEE_RAE, EMPLOYEE_NEWBEE)));
		assertEquals(2, tableModel.size());
		assertTrue(tableModel.contains(EMPLOYEE_DWARFENG));
		assertTrue(tableModel.contains(EMPLOYEE_RAE));
	}
	...
	public final void testSet() {
		assertEquals(EMPLOYEE_DWARFENG, tableModel.set(0, EMPLOYEE_NEWBEE));
		;
		assertEquals(EMPLOYEE_NEWBEE, tableModel.get(0));
		assertEquals(1, tableModelListener.eventList.size());
	...
	public final void testAddIntE() {
		assertTrue(tableModel.add(EMPLOYEE_NEWBEE));
		assertEquals(1, tableModelListener.eventList.size());
		assertEquals(TableModelEvent.INSERT, tableModelListener.eventList.get(0).getType());
		assertEquals(3, tableModelListener.eventList.get(0).getFirstRow());
		assertEquals(3, tableModelListener.eventList.get(0).getLastRow());
