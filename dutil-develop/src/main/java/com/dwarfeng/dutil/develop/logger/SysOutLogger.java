...
public class SysOutLogger implements Logger {
	...
	public void debug(String message) {
		autoUpdate();
		sysOut.println(String.format("%s\t[DEBUG]\t%s", formatDate(), message));
	}
	...
	public void error(String message, Throwable t) {
		autoUpdate();
		sysOut.println(String.format("%s\t[ERROR]\t%s", formatDate(), message));
	...
	public void fatal(String message, Throwable t) {
		autoUpdate();
		sysOut.println(String.format("%s\t[FATAL]\t%s", formatDate(), message));
		t.printStackTrace(sysOut);
	}
	...
	public void info(String message) {
		autoUpdate();
		sysOut.println(String.format("%s\t[INFO]\t%s", formatDate(), message));
	}
	...
	public void trace(String message) {
		autoUpdate();
		sysOut.println(String.format("%s\t[TRACE]\t%s", formatDate(), message));
	}
	...
	public void warn(String message) {
		autoUpdate();
		sysOut.println(String.format("%s\t[WARN]\t%s", formatDate(), message));
	}
