...
public interface BatchOperator<E> {
	 ...
	 *             快速失败异常。
	 */
	public BatchOperator<E> update(E element, Object updateObject) throws ConcurrentModificationException;
	 ...
	 *             快速失败异常。
	 */
	public BatchOperator<E> updateRemain(Object updateObject) throws ConcurrentModificationException;
