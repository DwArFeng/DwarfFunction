 ...
 * 计时器。
 * <p>
 * 计时器主要用于周期性的执行计划（{@link Plain}）。 与系统自带的计时器（{@link java.util.Timer}）相比，
 ...
 * 
 * <pre>
 * 1、{@linkplain Plain} 相比较 {@link TimerTask} 来说，没有取消机制——它没有取消方法。
...
public interface Timer extends ExternalReadWriteThreadSafe, ObverserSet<TimerObverser> {
	 ...
	 *             不支持该操作。
	 */
	public void awaitTermination() throws InterruptedException, UnsupportedOperationException;
