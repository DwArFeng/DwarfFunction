...
public class DefaultFormulaMatrix extends AbstractMathObject implements FormulaMatrix {
	 ...
	 * 矩阵的双精度浮点构造器。
	 * <p>
	 * 双精度浮点构造器会初始化一个指定行或者列的二维双精度浮点数组，其中的初始值为0。 <br>
	 * 可以给构造器中的二维数组指定的位置赋值。
	 * 
	 * @author DwArFeng
	 * @since 0.0.2-beta
	 ...
	 * 矩阵的值对象构造器。
	 * <p>
	 * 值对象构造器会初始化一个指定行或者列的二维值对象数组，其中的初始值为 {@link QuickFothValue#ZERO}。 <br>
	 * 可以给构造器中的二维数组指定的位置赋值。
	 * 
	 * @author DwArFeng
	 * @since 0.0.2-beta
	...
	public String getExpression() {
		...
		for (int i = 0; i < rows(); i++) {
			sb.append(formulaRowVectorAt(i).getExpression()).append(", ");
		}
