...
public final class LinalgeUtil {
	...
	public static boolean checkForMutiply(MatrixLike m1, MatrixLike m2){
		Objects.requireNonNull(m1, DwarfUtil.getExceptionString(ExceptionStringKey.LinalgeUtil_0));
		Objects.requireNonNull(m2, DwarfUtil.getExceptionString(ExceptionStringKey.LinalgeUtil_0));
	...
	public static boolean checkForMutiply(RowVector rowVector, ColumnVector columnVector){
		Objects.requireNonNull(rowVector, DwarfUtil.getExceptionString(ExceptionStringKey.LinalgeUtil_2));
		Objects.requireNonNull(columnVector, DwarfUtil.getExceptionString(ExceptionStringKey.LinalgeUtil_3));
	...
	public static void requireSpecificSize(MatrixLike mat, int row, int column){
		Objects.requireNonNull(mat, DwarfUtil.getExceptionString(ExceptionStringKey.LinalgeUtil_1));
	...
	public static void requireSpecificSize(LinalgeVector vector, int size){
		Objects.requireNonNull(vector, DwarfUtil.getExceptionString(ExceptionStringKey.LinalgeUtil_4));
