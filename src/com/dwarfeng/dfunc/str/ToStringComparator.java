...
public final class ToStringComparator<T> implements Comparator<T> {
	...
	public int compare(T o1, T o2) {
		Objects.requireNonNull(o1, DwarfFunction.getStringField(StringFieldKey.ToStringComparator_0));
		Objects.requireNonNull(o2, DwarfFunction.getStringField(StringFieldKey.ToStringComparator_0));
