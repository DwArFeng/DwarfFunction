...
import com.dwarfeng.func.util.ArraysFunc;
import com.dwarfeng.func.util.toStringComparator;
...
public class JMutableList<T> extends JList<T> {
	...
	public void removeElement(T[] objects){
		...
		if(getSelectionMode() == ListSelectionModel.SINGLE_SELECTION &&
				getSelectMode() == SELECT_AUTO && t != null && ArraysFunc.contains(objects, t)){setSelectedIndex(0);}
	}
	/**
	 * 从列表中删除所有元素。
	 */
