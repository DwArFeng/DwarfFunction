...
public final class CT {
	...
	//控制台输出前置是否添加系统时间的标志
	public static boolean dateTraceFlag = true;
	//控制台输出格式选择标志
	public static boolean dataFullFormatFlag = false;
	...
	public static String trace(String s){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+s;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	 * 在控制台中输出一个布尔变量。
	...
	public static String trace(boolean b){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+b;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	...
	public static String trace(int i){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+i;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	...
	public static String trace(float f){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+f;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	...
	public static String trace(double d){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+d;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	...
	public static String trace(long l){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+l;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	...
	public static String trace(char c){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+c;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
	/**
	...
	public static String trace(Object o){
		String Str =traceCurrentTime(dataFullFormatFlag)+"  \t"+o;
		if(dateTraceFlag) System.out.println(Str);
		return Str;
	}
