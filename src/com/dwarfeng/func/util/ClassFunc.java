...
public final class ClassFunc {
	...
	public static boolean isSubClass(Class<?> source,Class<?> target){
		Class<?>[] superClasses = ClassFunc.getAllSuperClassesArray(source);
		Class<?>[] superInterfaces = ClassFunc.getAllInterfacesArray(source);
		return ArraysFunc.contains(superClasses, target) || ArraysFunc.contains(superInterfaces, target);
	}
